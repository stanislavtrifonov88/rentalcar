...
export class newInitial1582713914045 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "contracts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "borrowerFirstName" text NOT NULL, "borrowerLastName" text NOT NULL, "borrowerAge" double precision NOT NULL, "startDate" text NOT NULL, "contractEndDate" text NOT NULL, "deliveredDate" text NOT NULL, "pricePaid" double precision NOT NULL DEFAULT 0, "isDeleted" boolean NOT NULL DEFAULT false, "carId" uuid, CONSTRAINT "PK_2c7b8f3a7b1acdd49497d83d0fb" PRIMARY KEY ("id"))`, undefined);
